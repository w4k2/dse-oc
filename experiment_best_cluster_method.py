...
for base_estimator, experiment_name in zip(base_estimators, experiment_names):
    ...
    methods = {
               ...
               "DSO-MB": DSO(cluster_method=MiniBatchKMeans),
               "DSO-KM": DSO(cluster_method=KMeans),
               "DSO-SC": DSO(cluster_method=SpectralClustering),
               "DSO-AC": DSO(cluster_method=AgglomerativeClustering),
               "DSO-BC": DSO(cluster_method=Birch),
              }
